...
def calculate_demographic_data(print_data=True):
    ...
    df['education_level'] = df['education'].apply(lambda x: 'higher' if x in higher_education_list else 'lower')
    # with and without `Bachelors`, `Masters`, or `Doctorate`
    higher_education = df[df['education_level']=='higher']
    lower_education = df[df['education_level']=='lower']
    ...
    countries =  df.groupby('native-country')['salary'].apply(
